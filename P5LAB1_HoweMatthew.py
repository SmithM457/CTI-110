...
#4/30/24
#P5LAB1
#Calculate change and owed change

##Import the file of change
##import change as c
...
def main():
    ...
    print()
    #Generate a random float with 2 decimal places as the amount the customer owes
    amount_owed = round(random.uniform(0.01, 100.00),2)
    #Display the amount owed
    print(f"You owe ${amount_owed:.2f}")
    print()
    #Prompt the user to enter a float as the cash they will put in the checkout machine
    ...
    print()
    #Convert the float change to an integer
    change_owed = round(change_owed * 100)
    print()
    #Call the disperse change function and pass change_owed as the parameter
    disperse_change(change_owed)
    ##c.disperse_change(change_owed)
